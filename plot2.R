...
#generating the plot2 line chart on screen
data.set$Global_active_power <- as.numeric(data.set$Global_active_power)
plot(data.set$Date,data.set$Global_active_power, ylab="Global Active Power (kilowatts)",xlab="", type = "l")

#create png file with this line chart
